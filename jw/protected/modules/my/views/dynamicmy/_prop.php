...
$propModel = Propcenter::model()->findByPk($model->dm_objectid);
?>
<div class="dxline">
    ...
    <span class="dx_04">
        <h5>
            <a href="<?=Yii::app()->createUrl("/user/view",array("id"=>$model->dm_fromid));?>" target="_blank"><?=$user->u_nickname?></a> 赠送我道具 <?=$propModel->pc_name?>
        </h5>
        <div class="p">
