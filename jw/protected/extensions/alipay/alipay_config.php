...
$partner		= "2088002324359479";

//安全检验码，以数字和字母组成的32位字符
$key   			= "nv7lw6tfl5107kmzjziw4ve6o00kwqwe";

//签约支付宝账号或卖家支付宝帐户
//$seller_email	= "feng.samuel@gmail.com"; 上线要打开

//交易过程中服务器通知的页面 要用 http://格式的完整路径，不允许加?id=123这类自定义参数
$notify_url		= DOMAIN."/my/accountrecharge/alipaynotify";

//付完款后跳转的页面 要用 http://格式的完整路径，不允许加?id=123这类自定义参数
//return_url的域名不能写成http://localhost/js_php_utf8/return_url.php ，否则会导致return_url执行无效
$return_url		= DOMAIN."/my/accountrecharge/buysuccess";

//网站商品的展示地址，不允许加?id=123这类自定义参数
$show_url		= DOMAIN."/my/accountrecharge/rechargelog";

//收款方名称，如：公司名称、网站名称、收款人姓名等
$mainname		= Yii::app()->params->name;
