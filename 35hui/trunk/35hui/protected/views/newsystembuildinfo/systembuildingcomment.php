...
<script src="/js/jquery.rating.js"></script>
	...
	<?php $this->renderPartial('_viewHead', array('get'=>$_GET,"select"=>"comment","type"=>$type)); ?>
    ...
    <div class="clear"></div>
          <div class="loupaninfo_fivelinerightbox">
              <?php $form=$this->beginWidget('CActiveForm', array(
                    ...
                    'action'=>'/newsystembuildinfo/addcomment/id/'.$model->sbi_buildingid,
...
<script type="text/javascript">
    ...
    function addCommentLog(id,obj){
        ...
        $.ajax({
            type:"post",
            url:"<?=Yii::app()->createUrl('/newsystembuildinfo/addcommentlog')?>",
            data: {"sbcl_cid":id},
    ...
    function addComment(){
        ...
        $.ajax({
            type:"post",
            url:"<?=Yii::app()->createUrl('/newsystembuildinfo/addcomment/id/'.$model->sbi_buildingid)?>",
            ...
            success: function(Msg){
                ...
                if(Msg =='发表评论成功!' || Msg =='发表评论成功！'){
                    window.location.href="<?=Yii::app()->createUrl("/newsystembuildinfo/view/id/{$_GET['id']}/tag/comment");?>";
                }
            }
        });
    }
