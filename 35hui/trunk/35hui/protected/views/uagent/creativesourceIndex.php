...
<div class="search">
    <div class="sctit">
        <form method="post" id="headSearchForm" action="<?php echo Yii::app()->createUrl('site/officeheadsearch');?>" onsubmit="changeValue('submit')">
            ...
            <input type="hidden" name="type" id="form_type" value="4" />
...
<div class="scmain">
    <div class="scleft">
        <div class="schtit">
            ...
            <div class="schtrt">
                <?php
                    echo CHtml::link("切换到经典找房模式",array("/creativesource/index"),array("class"=>"listbg"));
                ?>
            </div>
            <div class="schtpage">
                <?php
        ...
        if($allSource){
            foreach($allSource as $data){
                $this->renderPartial('_creativesearchindex', array('data'=>$data,'onlineUser'=>$onlineUser,));
            }
        }else{
        ?>
        <div class="schcont">
    ...
    $(document).ready(function(){
        ...
        $(".schcont .gemore span").bind("click", function(){
            ...
            if(typeof(userId)=="undefined"){
                ...
                $.ajax({
                    url:"/uagent/ajaxgetcreativesource",
                    type:"GET",
                    data:{"start":start,"userId":userId,"condition":condition},
