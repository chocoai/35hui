        ...
        <div class="schtan" style="display:none">
            <div class="schbord">
                <div class="rtcont" style="display:none;">
                    <p style="margin-bottom:5px;"><b>综合能力：</b></p>
                    <?if(@$uagentinfo->ua_source){ ?>
                    <div style="padding-top:6px; background:#fff url(../images/topup.jpg) no-repeat ;">
                    <div class="tb_upj">
                    <p style="margin-bottom:-35px;"><em><?=$uagentinfo->ua_source?><font class="dfen">分</font></em><b><?=Uagent::model()->formatUserOrder($uagentinfo->ua_ordernew)?></b></p>
                    <a href="<?=Yii::app()->createUrl("/uagent/index",array('id'=>$uagentinfo->ua_id))?>" target="_blank"><img src="/chart/radar/data/<?=Exam::model()->getChartInfo($data->ob_uid);?>/size/286x200" width="286" height="200" /></a></div>
                    </div>
                    ...
                    <p><b>成交案例：</b></p>
                    <div class="tb_up" >
                    <table cellpadding="0" cellspacing="0" border="0" class="table_09">
                        <?php
