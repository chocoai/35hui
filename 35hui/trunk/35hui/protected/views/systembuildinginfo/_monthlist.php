<ul class="threeline_boxleftulthree addserach"   onmouseover="this.className='threeline_boxleftulfour  addserach'" onmouseout="this.className='threeline_boxleftulthree  addserach'">
    <li class="ulthreeone">
        <a target="_blank" href="<?=Yii::app()->createUrl("/systembuildinginfo/view",array("id"=>$data->sbi_buildingid))?>"  title="">
    ...
    <li class="ulthreetwo">
        <strong><a target="_blank" href="<?=Yii::app()->createUrl("/systembuildinginfo/view",array("id"=>$data->sbi_buildingid))?>" title=""><?=CHtml::encode($data->sbi_buildingname);?></a></strong>
