<div class="hidden">
    <div class="panorama_navi_show">
        ...
        <div class="scrollable" style="width:850px;height:130px;margin-left: auto;margin-right: auto;">
            <div class="items" >
                <div style="width:850px;">
                    ...
                    ?>
                        <li class="item_vessel">
                            ...
                            <div class="item_title" title="<?=$panorama[$i]['p_title']?>"><?=$panorama[$i]['p_title']?></div>
                        </li>
                
                    <?
                        if(($i+1)%7==0){
                           echo "</div><div style='width:850px;'>";
                        }
                    }
                    ?>
                </div>
