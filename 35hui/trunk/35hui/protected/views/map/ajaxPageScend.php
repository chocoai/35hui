<div class="maptip" style="clear:both;position:absolute; top:100px;left:30%;z-index: 1001;" >
    <div class="bk_top">
    ...
    <div class="tipmain"style="clear:both">
        <h1>
            <div class="floatl">
                ...
                <div class="house">
                    ...
                    &nbsp;&nbsp;均价：<strong class="orange number"><?=$buildInfo->sbi_avgsellprice?$buildInfo->sbi_avgsellprice.'元/平米':'暂无资料';?></strong><br>
        ...
        <div class="tiplist" style="height: 302px">
            ...
            <dl>
                ...
                <dd>写字楼</dd>
                <dt class="orange" style="width:100px"><?php echo $value['ob_sumprice']?>万元/套</dt>
            ...
            <dl>
                <dt class="last">
                    ...
                    <br><?php echo $value['sb_floor']?>/<?php echo $value['sb_allfloor']?>层 <?=$value->sellInfo['ss_avgprice'];?>元/平米
                    <span class="gray9"><?=common::dealShowTime($value->sb_updatedate);?>更新 </span>
                </dt>
                <dd style="padding-top:15px">商铺</dd>
                <dd class="orange"><strong><?php echo $value->sellInfo['ss_sumprice']?></strong><br />万元/套</dd>
