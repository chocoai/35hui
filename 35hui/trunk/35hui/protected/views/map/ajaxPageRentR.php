        ...
        <div class="title">
            ...
            <div style="float:right; width: 220px">
                ...
                <select style="width:80px;color:#666;background-color: #E8EFFA" name="searchForm[price]" onchange="go(1)" id="price_tip">
                    ...
                    <option value="0-500" <?php if(isset($post['price'])&&$post['price']=="0-500")echo "selected='selected'"?>>500以下</option>
                    <option value="500-1000" <?php if(isset($post['price'])&&$post['price']=="500-1000")echo "selected='selected'"?>>500-1000</option>
                    <option value="1000-1500" <?php if(isset($post['price'])&&$post['price']=="1000-1500")echo "selected='selected'"?>>1000-1500</option>
                    <option value="1500-2000" <?php if(isset($post['price'])&&$post['price']=="1500-2000")echo "selected='selected'"?>>1500-2000</option>
                    <option value="2000-2500" <?php if(isset($post['price'])&&$post['price']=="2000-2500")echo "selected='selected'"?>>2000-2500</option>
                    <option value="2500-3000" <?php if(isset($post['price'])&&$post['price']=="2500-3000")echo "selected='selected'"?>>2500-3000</option>
                    <option value="3000-4000" <?php if(isset($post['price'])&&$post['price']=="3000-4000")echo "selected='selected'"?>>3000-4000</option>
                    <option value="4000-5000" <?php if(isset($post['price'])&&$post['price']=="4000-5000")echo "selected='selected'"?>>4000-5000</option>
                    <option value="5000-8000" <?php if(isset($post['price'])&&$post['price']=="5000-8000")echo "selected='selected'"?>>5000-8000</option>
                    <option value="8000-10000" <?php if(isset($post['price'])&&$post['price']=="8000-10000")echo "selected='selected'"?>>8000-10000</option>
                    <option value="10000-" <?php if(isset($post['price'])&&$post['price']=="10000-")echo "selected='selected'"?>>10000以上</option>
                </select>
            ...
            ?>
                <dl>
                    <dt class="last">
                        ...
                        <br><?php echo $value['rbi_floor']?>/<?php echo $value['rbi_allfloor']?>层
                        <span class="gray9"><?=common::dealShowTime($value->rbi_updatedate);?>更新 </span>
                    </dt>
                    <dd style="padding-top:15px">住宅</dd>
                    <dd class="orange"><strong><?=$value->rentInfo->rr_rentprice;?></strong><br />元/月</dd>
