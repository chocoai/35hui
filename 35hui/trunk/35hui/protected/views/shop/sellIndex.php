...
<div class="search">
    <div class="sctit">
        <form method="post" id="headSearchForm" action="<?php echo Yii::app()->createUrl('site/shopheadsearch'); ?>" onsubmit="changeValue('submit')">
            ...
            ?>
            <input type="hidden" name="sellorrent" value="2" />
...
<?php
        ...
        ?>
				...
				$this->widget('SearchMenu',array(
					'showMenu'=>array(1,21,3,23),//显示的条件
					'url'=>$url,//url
                    "sourceType"=>1,
...
<div class="scmain">
    <div class="scleft">
        <div class="schtit">
            <div class="schtlt">
                    ...
                    <div class="scmoren listbg">
                        <h5><?php
                            ...
                            if(isset($options["order"])){
                                ...
                                $options["order"]=="smu"?$select="售价由低到高":"";//物业管理费从低到高
                                $options["order"]=="smd"?$select="售价由高到低":"";//物业管理费从高到低
                        ...
                        <div class="ul" style="display:none">
                            <p><a href="/shop/sellIndex">默认排序</a></p>
                            <p><a href="<?php echo Yii::app()->createUrl($url,SearchMenu::dealOptions($options, "order", 'rtime'))?>">时间从新倒旧</a></p>
                            <p><a href="<?php echo Yii::app()->createUrl($url,SearchMenu::dealOptions($options, "order", 'smu'))?>">售价由低到高</a></p>
                            <p><a href="<?php echo Yii::app()->createUrl($url,SearchMenu::dealOptions($options, "order", 'smd'))?>">售价由高到低</a></p>
                ...
                <div class="sch_2">
                    <div class="zjpaixu" style="width:50px;">
                       <?php
						if(isset ($options['order'])&&$options['order']=="smu") {
							$options_tmp = 'smd';
							$class = "mrenup";
						}else if(isset ($options['order'])&&$options['order']=="smd") {
							$options_tmp = '';
							$class = "mrendown";
						}else {
							$options_tmp = "smu";
                ...
                <div class="sch_2">
                    <div class="zjpaixu" style="width:72px;">
                        ...
                        echo CHtml::link("面积",Yii::app()->createUrl($url,SearchMenu::dealOptions($options, "order", $options_tmp)),array("class"=>"listbg ".$class));
						?>
            ...
            <div class="schtrt">
                <?php
                    echo CHtml::link("切换到经纪人找房模式",array("/uagent/shopsale"),array("class"=>"listbg"));
                ?>
            </div>
            <div class="schtpage">
                <?php
        ...
        foreach($allSource as $data){
            $this->renderPartial('_sellIndex', array('data'=>$data));
        }
