<div class="schcont">
		<div class="schdes">
			...
			<div class="sp_txt">
				...
				<p><?=$data->sb_businesstype!=3?Shopbaseinfo::$sb_profession[$data->sb_profession]."，":""?><?=Shopbaseinfo::$sb_businesstype[$data->sb_businesstype]?><em><?=@$data->sellInfo->ss_avgprice?></em>元/㎡</p>
				<p>咨询热线：
                    <?
                $cdb=new CDbCriteria();
			...
			<div class="sp_sell"><em><?=@$data->sellInfo->ss_sumprice?></em>万元</div>
		</div>
	</div>