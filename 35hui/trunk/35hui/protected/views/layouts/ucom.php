...
<title>新地标中介公司管理后台</title>
<meta name="description" content="新地标中介公司管理后台" />
<meta name="keywords" content="新地标中介公司管理后台" />
...
<!--header start-->
    <div class="header clearfix">
        <a href="<?=DOMAIN; ?>"><img src="<?=IMAGE_URL; ?>/manage_logo.gif" alt="" class="manage_logo" /></a><img src="<?=IMAGE_URL; ?>/co_manage_font.gif" alt="经纪人管理系统" class="manage_font" />
	  <ul>
	    <li class="three"></li>
		<li class="two"><span><a href="<?php echo User::model()->getUrl()?>"><?=Yii::app()->user->name; ?></a>您好！</span><code><?=CHtml::link("论坛",BBS_DOMAIN,array("target"=>"_blank"));?>|&nbsp;客服热线：400-820-9181&nbsp;|<a href="<?php echo Yii::app()->createUrl('/site/logout'); ?>">安全退出</a></code></li>
		<li class="one"></li>
	  </ul>
	</div>
	...
	<div class="navigation clearfix">
	  <img src="<?=IMAGE_URL; ?>/manage_navl.jpg" style="float:left;" />
       <?php $this->renderPartial('/ucom/swHuiPost'); ?>
...
<!--header end-->
    <div class="clearfix">
        ...
        <div class="manage_left">
            <?php
            $this->renderPartial('/ucom/leftmenu');
            ?>
        </div>
        <!--left end-->
        <!--right start-->
