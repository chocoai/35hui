...
?>
    <div class="space">
		<div class="lfspace"><a href="/">首页</a>&gt;<?php echo CHtml::link($model->cp_name,array('view','id'=>$model->cp_name)) ?>&gt;<em>相册</em></div>
...
<?php
$albums = Picture::model()->findAll(array('condition'=>'p_sourcetype=9 AND p_sourceid='.$model->cp_id));
if($albums){
?>
	<div class="detcont">
        <div class="dllcont">
