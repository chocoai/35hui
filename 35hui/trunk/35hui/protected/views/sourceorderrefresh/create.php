...
<form action="" method="post">
    <table width="580" border="0" cellpadding="0" cellspacing="0" style="border: 1px solid #C4CFE1; background-color: #FFFFFF; height:500px;" align="center">
        <tr>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#f5f5f5">
                    ...
                    <tr>
                        <td colspan="3">
                            ...
                            <a href="#" class="bluet" onclick="parent.location.href='/orderrefreshscheme/index/menu/<?=$this->temp?>'">现在就制定方案</a>
                            <?php
                            }
                            ?>
                            &nbsp;
                            <input type="button" value="设置预约刷新方案" onclick="javascript:window.parent.location.href='/orderrefreshscheme/index/menu/<?=$this->temp?>'">
                        </td>
                    </tr>
                    <tr>
                        <td colspan="3">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td align="center" bgcolor="#f5f5f5">
                            <input type="submit" id="btnSubmit" value="确定" onclick="return SaveFreshHouse()">
                            &nbsp;
                            <input type="button" onclick="parent.closeTip()" value="取消">
                        </td>
                    </tr>
                </table>
            </td>
