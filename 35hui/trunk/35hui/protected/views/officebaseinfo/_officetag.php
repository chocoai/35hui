<ul class="serach_moremenu">
    ...
    ?>
    <li class="<?=array_key_exists('sourcetag', $options)&&$options['sourcetag']==3?"one":"two"?>" style="position:relative;"><em class="top_hot"></em><strong><a href="<?php echo Yii::app()->createUrl($url, SearchMenu::dealOptions(array(), "sourcetag", "3"))?>">全景房源</a></strong></li>
    <?
    }
    ?>
    <?
