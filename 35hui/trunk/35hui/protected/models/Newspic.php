...
class Newspic extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('np_title, np_picurl, np_linkurl, np_type', 'required'),
            ...
            array('np_picurl','file','types'=>'jpg, gif, png','maxSize'=>1024 * 1024 * 2,'tooLarge'=>'上传文件必须小于2M'),
	...
	public function search()
	{
		...
		$criteria->compare('np_type',$this->np_type);
    ...
    public function getOnePicByType($type){
        $row = $this->find("np_type=:type",array(
            'type'=>$type
        ));
        return $row;
    }
     ...
     * @return <type>
     */
    public function getLimitPicNews($picType,$limit = 10){
        $criteria=new CDbCriteria;
        $criteria->condition = "np_type=".$picType;
		$criteria->limit=$limit;
		$criteria->order="np_order";
		$pic=$this->findAll($criteria);
        return $pic;
    }
}