...
class Residencerentinfo extends CActiveRecord
{
     ...
     *朝向
     */
    public static $faciliti_base = array(
        1 => '电视机',
        2 => '冰箱',
        3 => '空调',
        4 => '洗衣机',
	...
	public function rules()
	{
		...
		return array(
			array('rr_rentprice, rr_rentpay, rr_renttype, rr_rentdetain', 'required'),
			array('rr_rbiid, rr_rentpay, rr_renttype, rr_rentdetain', 'numerical', 'integerOnly'=>true),
			array('rr_rentprice', 'numerical'),
			array('rr_facilities', 'length', 'max'=>200),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('rr_id, rr_rbiid, rr_rentprice, rr_rentpay, rr_rentdetain, rr_facilities', 'safe', 'on'=>'search'),
		);
	}
