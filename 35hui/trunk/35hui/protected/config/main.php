...
//        ),
        ...
        'urlManager'=>array(
			...
			'rules'=>array( 
				...
				"newbuild/<id:\d+>.html"=>"newsystembuildinfo/view",
				"newbuildlist/shop/*"=>"newsystembuildinfo/newbuildindex",
				"newbuildlist*"=>"newsystembuildinfo/newbuildlist",
				"shoptransfer*"=>"shop/transferIndex",
