...
class ShareController extends Controller
{
    ...
    public function actionRelease(){
        if(!Yii::app()->request->isPostRequest || !in_array($_POST['tag'],array('gc','gp')) ) $this->redirect(array('main/error'));
    ...
    public function actionIndex(){
        ...
        if( !empty($request['sourceType']) && in_array($request['sourceType'],array('1','2','3')) ){
            $sourceType=$request['sourceType'];
        }else{
            $sourceType=Yii::app()->user->getState('mainbusiness','1');//主营物业
        }
