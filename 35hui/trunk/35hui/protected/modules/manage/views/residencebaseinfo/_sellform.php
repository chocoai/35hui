...
<div class="rgcont">
    <table cellspacing="0" cellpadding="0" border="0" class="table_01">
        ...
        <tr>
            ...
            <td width="84%" class="txtlou">
                <input style="background-color:#CCC; color:#999;" type="text" id="officeaddress" name="ob_officeaddress" size="55" value="<?=empty($temp->comy_address)?'':$temp->comy_address ?>" readonly="true"/></td>
        </tr>
        <tr>
            <td width="16%" class="tit"><em>*</em> 产证面积：</td>
            <td width="84%" class="txtlou">
                <input type="text" id="rbi_area" onblur="checkArea(this)" onkeyup="checkArea(this)" name="rbi_area" size="10" maxlength="10" value="<?=$model->rbi_area?>" /> 平方米
        ...
        <tr>
            ...
            <td width="84%" class="txtlou">
                总价 <input type="text" id="rs_price" name="rs_price" size="15" onblur="CheckSumSalePriceAndGetAvgPrice(this)" onkeyup="CheckSumSalePriceAndGetAvgPrice(this)" value="<?=$sellModel->rs_price?>" /> 万元/套
                - 单价 <input type="text" id="rs_unitprice" name="rs_unitprice" size="10" onblur="CheckAvgPrice(this)" value="<?=$sellModel->rs_unitprice?>" /> 元/平米
                <span class="errorMessage"></span>
            </td>
        </tr>
        <tr>
            ...
            <td width="84%" class="txtlou">
                ...
                <?php echo CHtml::error($model,'rbi_floor'); ?>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td width="16%" class="tit">是否有租约：</td>
            <td width="84%" class="txtlou">
                <input type="radio" name="rs_lease" value="0"<?=$sellModel->rs_lease==1?'':' checked' ?> /><label for="rs_lease_0">否</label>&nbsp;&nbsp;
                <input type="radio" name="rs_lease" value="1"<?=$sellModel->rs_lease==1?' checked':'' ?>/><label for="rs_lease_1">是</label>&nbsp;&nbsp;
            </td>
        </tr>
    </table>
</div>
...
function submitValidate(){
    ...
    if(!CheckSumSalePrice($("#rs_price"))){//验证售价
        $("#rs_price").focus();
        return false;
    }
    if(!CheckAvgPrice($("#rs_unitprice"))){//验证均价
        $("#rs_unitprice").focus();
        return false;
    }
