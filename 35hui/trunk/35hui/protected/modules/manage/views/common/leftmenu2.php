...
<p><a id="viewIntegral"href="<?php echo Yii::app()->createUrl('/manage/manage/viewIntegral');?>" target="frame">积分管理</a></p>
<p><a id="combo" href="<?php echo Yii::app()->createUrl('/manage/buycombo/index');?>" target="frame">推广方案</a></p>
