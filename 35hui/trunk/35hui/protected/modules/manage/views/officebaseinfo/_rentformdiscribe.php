    ...
    <div class="rgcont">
        <table cellspacing="0" cellpadding="0" border="0" class="table_01">
            ...
            <tr>
                ...
                <td class="txtlou">
                    <input type="hidden" value="<?=$model->buildingInfo?$model->buildingInfo->sbi_avgrentprice:""?>" id="avgprice" />
					...
					<input type="hidden" value="<?=$model->ob_pricecheck?>" id="ob_pricecheck" name="ob_pricecheck"/>
                    <br />
