    ...
    <div class="rgcont">
        <table cellspacing="0" cellpadding="0" border="0" class="table_01">
            ...
            <tr>
                ...
                <td class="txtlou">
                    <input type="hidden" value="<?=$model->parkbaseinfo?$model->parkbaseinfo->cp_avgrentprice :""?>" id="avgprice" />
					...
					<input type="hidden" value="<?=$model->cr_pricecheck?>" id="cr_pricecheck" name="cr_pricecheck"/>
                    <br />
			...
			<tr>
                ...
                <td class="txtlou">
                    <textarea id="cr_introduce" style="width:300px;height:100px" name="cr_introduce" maxlength="300" ><?=CHtml::encode($model->cr_introduce)?></textarea>
					<br>描述不超过300字
                </td>
            </tr>
