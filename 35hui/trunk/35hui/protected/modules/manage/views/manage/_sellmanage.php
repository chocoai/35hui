...
<tr>
    ...
    <td class="txt">
            ...
            $_c1='color:blue';
            $_c2='color:#F8941D';
            echo CHtml::link("图片管理",array("/manage/picture/photomanage",'id'=>$data->ob_officeid,'sourcetype'=>"office"),array('class'=>'','style'=>$_c1,'target'=>'frame')).'<br/>';
     
            echo CHtml::link("全景管理",array("/manage/subpanorama/index",'id'=>$data->ob_officeid,'type'=>"1"),array('class'=>'','style'=>$_c2,'target'=>'frame'));
...
<tr>
    ...
    <td width="37%" class="txt" align="left">
        <span><?php
            ...
            ?>
        <span><?=$data->sb_sellorrent==1?Shopbaseinfo::$rengtype[$data->rentInfo->sr_renttype]:"";?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo $url; ?>">编辑</a></span></td>
    <td class="txt">
            <?php
            $_c1='color:blue';
            $_c2='color:#F8941D';
            
            echo CHtml::link("图片管理",array("/manage/picture/photomanage",'id'=>$data->sb_shopid,'sourcetype'=>"shop"),array('class'=>'tabmargin','style'=>$_c1,'target'=>'frame')).'<br/>';

            echo CHtml::link("全景管理",array("/manage/subpanorama/index",'id'=>$data->sb_shopid,'type'=>"2"),array('class'=>'tabmargin','style'=>$_c2,'target'=>'frame'));
