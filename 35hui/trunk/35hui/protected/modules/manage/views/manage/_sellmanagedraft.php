...
<tr>
    ...
    <td class="txt">
        <a href="javascript:oprationOne(<?php echo $data->ob_officeid.",4"?>)">发布</a>
    </td>
    <td class="txt">
            <?php echo date('Y-m-d H:i',$data->ob_releasedate);?>
    </td>
</tr>
    <?php
...
<tr>
    ...
    <td class="txt">
        <a href="javascript:oprationOne(<?php echo $data->sb_shopid.",4"?>)">发布</a>
    </td>
...
<tr>
    ...
    <td width="10%"><?php echo date("Y-m-d H:i",$data->rbi_releasedate); ?></td>
</tr>
    <?php
...
<tr>
    ...
    <td class="txt">
        <a href="javascript:oprationOne(<?php echo $data->cr_id.",4"?>)">发布</a>
    </td>
    <td class="txt">
            <?php echo date('Y-m-d H:i',$data->cr_releasedate);?>
    </td>
</tr>
    <?php
}