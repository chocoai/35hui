...
0
|| checktplrefresh('./template/default/forum/discuz.htm', './template/default/common/header.htm', 1334552501, 'diy', './data/template/1_diy_forum_discuz.tpl.php', './template/default', 'forum/discuz')
|| checktplrefresh('./template/default/forum/discuz.htm', './template/default/common/footer.htm', 1334552501, 'diy', './data/template/1_diy_forum_discuz.tpl.php', './template/default', 'forum/discuz')
|| checktplrefresh('./template/default/forum/discuz.htm', './template/default/common/header_common.htm', 1334552501, 'diy', './data/template/1_diy_forum_discuz.tpl.php', './template/default', 'forum/discuz')
|| checktplrefresh('./template/default/forum/discuz.htm', './template/default/common/pubsearchform.htm', 1334552501, 'diy', './data/template/1_diy_forum_discuz.tpl.php', './template/default', 'forum/discuz')
;?>
...
请 <a href="/site/login" class="xi2"><strong>登录</strong></a> 后使用快捷导航<br />没有帐号？<a href="/site/register" class="xi2 xw1"><?php echo $_G['setting']['reglinkname'];?></a>
</div>
<?php } ?>
</div>
...
<span class="pipe">|</span><a href="/site/logout">退出</a>
</p>
<p>
...
<div id="ct" class="wp cl<?php if($_G['setting']['forumallowside']) { ?> ct2<?php } ?>">
    ...
    <div class="mn">
        ...
        <div class="fl bm">
            <?php if(is_array($catlist)) foreach($catlist as $key => $cat) { ?>            <div class="bm bmw <?php if($cat['forumcolumns']) { ?> flg<?php } ?> cl">
                <div class="bm_h cl">
                    <span class="o">
                        ...
                        <tr>
                            <?php if(is_array($cat['forums'])) foreach($cat['forums'] as $forumid) { ?>                                <?php $forum=$forumlist[$forumid];?>                                <?php $forumurl = !empty($forum['domain']) && !empty($_G['setting']['domain']['root']['forum']) ? 'http://'.$forum['domain'].'.'.$_G['setting']['domain']['root']['forum'] : 'forum.php?mod=forumdisplay&fid='.$forum['fid'];?>                                <?php if($cat['forumcolumns']) { ?>
                                ...
                                <td width="49.9%">
                                    ...
                                    <?php if($forum['icon']) { ?><?php echo $forum['icon'];?>
                                    <?php } else { ?>
                                    ...
                                    <dl style="margin-left: 31px;padding-left: 8px;line-height: 22px">
                                        <dt>
                                            <a href="<?php echo $forumurl;?>"<?php if($forum['redirect']) { ?> target="_blank"<?php } if($forum['extra']['namecolor']) { ?> style="color: <?php echo $forum['extra']['namecolor'];?>;"<?php } ?>><font size="2" style="font-weight:bold"><?php echo $forum['name'];?></font></a><?php if($forum['todayposts'] && !$forum['redirect']) { ?><em class="xw0 xi1" title="今日"> (<?php echo $forum['todayposts'];?>)</em><?php } ?>
                                            <?php if($forum['description']) { ?><span><?php echo $forum['description'];?></span<?php } ?>
                                            <?php if($forum['subforums']) { ?><span>子版块: <?php echo $forum['subforums'];?></span><?php } ?>
                                            <?php if($forum['moderators']) { ?><span>版主: <font><?php echo $forum['moderators'];?></font></span><?php } ?>
                                        </dt>
                                        <dt>
                                            <?php if(empty($forum['redirect'])) { ?>主题:<span class="xi2"><?php echo $forum['threads'];?></span>,帖数:<span class="xg1"><?php echo $forum['posts'];?></span><?php } ?>
                                        </dt>
                                        <dt>
...
私密版块
                                            ...
                                            <a href="forum.php?mod=redirect&amp;tid=<?php echo $forum['lastpost']['tid'];?>&amp;goto=lastpost#lastpost" class="xi2"><?php echo cutstr($forum['lastpost']['subject'], 42); ?></a> <cite><?php echo $forum['lastpost']['dateline'];?> <?php if($forum['lastpost']['author']) { ?><?php echo $forum['lastpost']['author'];?><?php } else { ?><?php echo $_G['setting']['anonymoustext'];?><?php } ?></cite>
                                            <?php } else { ?>
                                                                                        从未
                                            <?php } ?>
                                            <?php } ?>
