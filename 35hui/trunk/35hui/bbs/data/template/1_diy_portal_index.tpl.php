...
0
|| checktplrefresh('./template/default/portal/index.htm', './template/default/common/header.htm', 1335229329, 'diy', './data/template/1_diy_portal_index.tpl.php', './template/default', 'portal/index')
|| checktplrefresh('./template/default/portal/index.htm', './template/default/common/footer.htm', 1335229329, 'diy', './data/template/1_diy_portal_index.tpl.php', './template/default', 'portal/index')
|| checktplrefresh('./template/default/portal/index.htm', './template/default/common/header_common.htm', 1335229329, 'diy', './data/template/1_diy_portal_index.tpl.php', './template/default', 'portal/index')
|| checktplrefresh('./template/default/portal/index.htm', './template/default/common/pubsearchform.htm', 1335229329, 'diy', './data/template/1_diy_portal_index.tpl.php', './template/default', 'portal/index')
;?>
