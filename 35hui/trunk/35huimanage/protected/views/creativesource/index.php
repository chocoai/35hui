...
function checkPost(t,type,id){
    ...
    var com;
        ...
        if(com!=null&&com!=""){
            $.ajax({
                url:"<?php echo Yii::app()->createUrl("creativesource/changetag") ?>"+"/sourceType/4/id/"+id,
...
function search(){
    window.location.href="<?=Yii::app()->createUrl('creativesource/index',array('type'=>""));?>/"+$("#od").val();
}
</script>
