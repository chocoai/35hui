<div class="view">
    ...
    <div class="right-tip">
        ...
        <div class="right-id-tip deepskyblue">
            <?php echo CHtml::link(CHtml::encode($data->comy_id), array('view', 'id'=>$data->comy_id)); ?>
        </div>
    </div>

	<b><?php echo CHtml::encode($data->getAttributeLabel('comy_name')); ?>:</b>
	<?php echo CHtml::encode($data->comy_name); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('comy_province')); ?>:</b>
	<?php echo CHtml::encode(Region::model()->getNameById($data->comy_province)); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('comy_city')); ?>:</b>
	<?php echo CHtml::encode(Region::model()->getNameById($data->comy_city)); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('comy_district')); ?>:</b>
	<?php echo CHtml::encode(Region::model()->getNameById($data->comy_district)); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('comy_inserttime')); ?>:</b>
	<?php echo CHtml::encode(showFormatDateTime($data->comy_inserttime)); ?>
	<br />
