...
echo CHtml::dropDownList('od',$type,
        array("4"=>'发布的房源',"8"=>'下线的房源',"10"=>'楼盘已空的发布房源',"11"=>'价格过低的发布房源'),
...
function checkPost(t,type,id){
    ...
    var com;
        ...
        if(com!=null&&com!=""){
            $.ajax({
                url:"<?php echo Yii::app()->createUrl("officebaseinfo/changetag") ?>"+"/sourceType/1/id/"+id,
...
function search(){
    window.location.href="<?=Yii::app()->createUrl('officebaseinfo/index',array('type'=>""));?>/"+$("#od").val();
}
</script>
