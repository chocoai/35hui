...
class Medal extends CActiveRecord
{
    ...
    public function medalReward($userId,$md_type,$rankId){
       ...
       $reward = array(
            4=>array(//邀请
                array(30,100,200,1000,5000),//商务币
                array(30,100,200,2000,5000),//积分
            ),
            9=>array(//房源
                array(50,300,500,2000,5000,15000),//商务币
                array(50,300,500,2000,5000,15000),//积分
            )
        );
        $money = $reward[$md_type][0][$rankId];
        $description = "恭喜您获得".$missionName[$md_type]."奖章，系统赠送{:money}商务币";
        Userproperty::model()->addMoney($userId, $money, $description);
