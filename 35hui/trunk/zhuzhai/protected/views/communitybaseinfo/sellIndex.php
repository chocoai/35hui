        ...
        <div id="yw0" class="portlet">
            <div class="portlet-content">
                <div style="margin-top: -3px; margin-bottom: -7px;" class="tab10">
                    <dl>
                        <dt class="<?=$this->Action->getId()=="sellIndex"?"now":"out"?>"><a href="<?=Yii::app()->createUrl("communitybaseinfo/sellIndex")?>">按区域查找</a></dt>
                        <dt class="<?=$this->Action->getId()=="dtsellIndex"?"now":"out"?>"><a href="<?=Yii::app()->createUrl("communitybaseinfo/dtsellIndex")?>">按地铁查找</a></dt>
                    </dl>
                </div>
                <?php
            ...
            <div class="serach_lefttwobox">
                <ul class="serach_nav">
                    ...
                    <li class="two" style="width: 400px;">
                        ...
                        ?>
                        <a class="<?=$class?>" href="<?php echo Yii::app()->createUrl($url,SearchMenu::dealOptions($options, "order", $options_tmp))?>">总价</a>
                        <?php
                        $options_tmp = $options;
