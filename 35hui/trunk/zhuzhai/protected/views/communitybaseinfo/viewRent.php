...
$rr_rentprice=$residenceModel->rentInfo->rr_rentprice;
$keywords=$comy_name.'租房，租金'.$rr_rentprice;
$agentInfo = Uagent::model()->findByAttributes(array('ua_uid'=>$ownerInfo->user_id));
$description=$comy_city.$comy_district.','.$keywords.',面积：'.$residenceModel->rbi_area.'平方，朝向：'.$rbi_toward.',';
...
$this->pageTitle = $comy_name.'租房，'.$comy_city.$comy_name.'360°全景看房，'.$comy_name.'租金'.$rr_rentprice.' - 新地标';
?>
...
<div id="two_left">
    ...
    <div class="w725 border" style="width:705px; overflow:hidden; margin-bottom:10px; border:0; margin-left: 0; padding-left: 0; padding-top:10px;">
            <?php
