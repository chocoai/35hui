...
<div class="xzcont">
    <div class="zxborder">
        <div class="<?php echo $medals[4]->md_rank?'yes':'no';?>">
            <div class="topimg">
                <?php
                if($medals[4]->md_rank){
        ...
        <div class="layerBox hidden">
            ...
            <div class="layerBoxCon">
                ...
                <div class="line"></div>
                <div class="btcontent">
                    <p >再邀请<?php echo $nextMedals[4]-$medals[4]->md_size; ?>人即可获得此勋章! </p>
                </div>
    ...
    <div class="zxborder">
        ...
        <div class="layerBox hidden">
            ...
            <div class="layerBoxCon">
                ...
                <div class="line"></div>
                <div class="btcontent">
                    <p class="honortip">再连续<?php echo $nextMedals[9]-$medals[9]->md_size; ?>天发布新房源，即可获得这枚勋章! </p>
                </div>
                <div class="clearit"></div>
            </div>
        </div>
