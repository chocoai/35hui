...
<form action="/manage/msg/delete" method="post">
    <div class="rgcont">
        <table border="0" cellpadding="0" cellspacing="0" class="table_01">
            <tr>
                <td class="ftit" colspan="2">留言标题</td>
                <td width="15%" class="ftit">留言人</td>
                <td width="19%" class="ftit">留言时间</td>
                <td width="9%" class="ftit">状态</td>
                <td width="11%" class="ftit">操作</td>
            </tr>
            <?php
            foreach($dataProvider->getData() as $data){
                $this->renderPartial('_receivelist', array('data'=>$data));
            }
            ?>
        </table>
    </div>
