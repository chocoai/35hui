...
<div class="inmsg">
    ...
    <div class="inright">
        ...
        <div class="inline">
            <span class="in_01">积分等级：<?php echo User::model()->getUserLevelByUserId($userid)?></span>
            <span class="in_01">推广方案：<?php
            $icon = Uagent::model()->getAgentComboIconUrl($umodel);
            if($icon){
                echo $icon."&nbsp;&nbsp;".date("Y-m-d",$umodel->ua_combotime)."到期";
            }else{
                echo "未购买".CHtml::link('查看',array("/manage/buycombo"));
            }?></span>
        </div>
        <div class="inline">
