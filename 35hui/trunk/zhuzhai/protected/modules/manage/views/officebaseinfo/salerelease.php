...
<div class="htguanle">
    <ul>
        <li class="clk"><a href="javascript:;">发布写字楼出售信息</a></li>
        <!--<li><a href="<?php echo $this->createUrl('/manage/shopbaseinfo/sellrelease'); ?>">发布商铺出售信息</a></li>
        <li><a href="<?php echo $this->createUrl('/manage/residencebaseinfo/sellrelease'); ?>">发布住宅出售信息</a></li>-->
    </ul>
    <div class="moren"><?php echo CHtml::link('修改主营物业',array("/manage/user/index")); ?></div>
</div>

<?php echo $this->renderPartial('_saleformdiscribe', array(
    'model'=>$model,
