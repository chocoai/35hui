...
//            echo "Message sent!";
     ...
     * @return <string>
     */
    public static function getApcCacheKey($controller,$action){
        $key = $controller."_".$action;
        return $key;
//        if($_SERVER['REDIRECT_URL']){
//            $redirectUrl = substr($_SERVER['REDIRECT_URL'], 1);
//            $arr = split("/", $redirectUrl);
//            if(count($arr)>=2){
//                $tmpArr = array($arr[0],$arr[1]);
//                $str = implode("_", $tmpArr);
//                return $str;
//            }else{
//                throw new CHttpException(400,'地址错误，生成ApcCacheKey失败。请修改方法getApcCacheKey()！');
//            }
//        }else{
//            throw new CHttpException(400,'没有重写url，生成ApcCacheKey失败。请修改方法getApcCacheKey()！');
//        }
    }
    /**
