...
0
|| checktplrefresh('./template/default/ranklist/ranklist.htm', './template/default/ranklist/side_left.htm', 1318139774, 'diy', './data/template/1_diy_ranklist_ranklist.tpl.php', './template/default', 'ranklist/ranklist')
...
<?php if($_G['setting']['homestatus'] && $ranklist_setting['picture']['available']) { ?>
<div class="rnk1">
<div class="bm">
<div class="bm_h cl">
<span class="y xi2">
...
<?php } ?><?php unset($pictures[0]);?><?php if(is_array($pictures)) foreach($pictures as $pic) { ?><li class="d">
<div class="c">
...
<?php } if($_G['setting']['homestatus'] && $ranklist_setting['blog']['available']) { ?>
<div class="bm">
<div class="bm_h cl">
...
<?php } if($ranklist_setting['thread']['available']) { ?>
<li class="cl<?php if($_G['gp_type'] == 'thread') { ?> a<?php } ?>"><a href="misc.php?mod=ranklist&amp;type=thread&amp;view=replies&amp;orderby=thisweek">帖子</a></li>
<?php } if($_G['setting']['homestatus'] && $ranklist_setting['blog']['available']) { ?>
<li class="cl<?php if($_G['gp_type'] == 'blog') { ?> a<?php } ?>"><a href="misc.php?mod=ranklist&amp;type=blog&amp;view=heats&amp;orderby=thisweek">日志</a></li>
<?php } if($ranklist_setting['poll']['available']) { ?>
<li class="cl<?php if($_G['gp_type'] == 'poll') { ?> a<?php } ?>"><a href="misc.php?mod=ranklist&amp;type=poll&amp;view=heats&amp;orderby=thisweek">投票</a></li>
<?php } if($ranklist_setting['activity']['available']) { ?>
<li class="cl<?php if($_G['gp_type'] == 'activity') { ?> a<?php } ?>"><a href="misc.php?mod=ranklist&amp;type=activity&amp;view=heats&amp;orderby=thismonth">活动</a></li>
<?php } if($_G['setting']['homestatus'] && $ranklist_setting['picture']['available']) { ?>
<li class="cl<?php if($_G['gp_type'] == 'picture') { ?> a<?php } ?>"><a href="misc.php?mod=ranklist&amp;type=picture&amp;view=hot&amp;orderby=thismonth">图片</a></li>
<?php } if($ranklist_setting['forum']['available']) { ?>
<li class="cl<?php if($_G['gp_type'] == 'forum') { ?> a<?php } ?>"><a href="misc.php?mod=ranklist&amp;type=forum&amp;view=threads">版块</a></li>
<?php } if($ranklist_setting['group']['available']&&$_G['setting']['groupstatus']) { ?>
<li class="cl<?php if($_G['gp_type'] == 'group') { ?> a<?php } ?>"><a href="misc.php?mod=ranklist&amp;type=group&amp;view=credit">群组</a></li>
<?php } ?>
</ul>
