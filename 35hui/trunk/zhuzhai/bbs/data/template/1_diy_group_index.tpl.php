...
0
|| checktplrefresh('data/diy/group/index.htm', './template/default/common/header.htm', 1318139773, 'diy', './data/template/1_diy_group_index.tpl.php', 'data/diy', 'group/index')
|| checktplrefresh('data/diy/group/index.htm', './template/default/common/footer.htm', 1318139773, 'diy', './data/template/1_diy_group_index.tpl.php', 'data/diy', 'group/index')
|| checktplrefresh('data/diy/group/index.htm', './template/default/common/header_common.htm', 1318139773, 'diy', './data/template/1_diy_group_index.tpl.php', 'data/diy', 'group/index')
|| checktplrefresh('data/diy/group/index.htm', './template/default/common/pubsearchform.htm', 1318139773, 'diy', './data/template/1_diy_group_index.tpl.php', 'data/diy', 'group/index')
;
block_get('1,2');?>
...
<!--[diy=diy5]--><div id="diy5" class="area"><div id="frame4PUu0a" class="frame move-span cl frame-1-1"><div id="frame4PUu0a_left" class="column frame-1-1-l"><div id="frame4PUu0a_left_temp" class="move-span temp"></div><?php block_display('1');?></div><div id="frame4PUu0a_center" class="column frame-1-1-r"><div id="frame4PUu0a_center_temp" class="move-span temp"></div><?php block_display('2');?></div></div></div><!--[/diy]-->
</div>
...
<div class="bm_c cl"><?php if(is_array(unserialize($_G['setting']['group_recommend']))) foreach(unserialize($_G['setting']['group_recommend']) as $val) { ?><dl class="xld">
...
<div class="bm_c"><?php if(is_array($first)) foreach($first as $groupid => $group) { if($group['secondlist']) { ?>
